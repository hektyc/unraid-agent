...
/* --- Accordion sections (Tool Access within Permissions) --- */
.ua-acc-section { border:1px solid rgba(128,128,128,0.3); border-radius:8px; margin-bottom:10px; }
.ua-acc-header { display:flex; align-items:center; padding:10px 14px; cursor:pointer; user-select:none; }
.ua-acc-header:hover { background:rgba(128,128,128,0.08); }
.ua-acc-title { font-size:14px; font-weight:bold; }
.ua-acc-caret { display:inline-block; font-size:16px; transition:transform .15s; }
.ua-acc-body { display:none; padding:0 12px 12px; }
.ua-domain { margin-bottom:8px; }
...
.ua-domain-tools { display:none; padding:4px 12px 10px; }
