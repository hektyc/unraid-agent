...
cp plugin/webgui/unraid-mcp.settings.page "$INSTALL_DIR/webgui/unraid-mcp.settings.page"
mkdir -p "$CONFIG_DIR/webgui"
cp plugin/webgui/unraid-mcp.settings.page "$CONFIG_DIR/webgui/unraid-mcp.settings.page"
